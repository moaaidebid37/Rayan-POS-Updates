...
(function () {
  ...
  const ALL_FEATURES = [
    ...
    { text: 'شركات التوصيل'                    },
    { text: 'Solo AI — مدير حساباتك الذكي 🤖'  },
  ];
  ...
  const PLANS = [
    {
      ...
      days:  '30 يوم',
      color: '#4a9eff',
      features: _planFeatures(12),   // كل المميزات مفتوحة في التجربة
      cta:   'جرّب مجاناً',
    },
    {
      id:    'basic',
      ...
      period: '/شهر',
      color: GOLD,
      features: _planFeatures(4),    // أول 4 مميزات (POS, أصناف, طلبات, KDS)
      cta:   'ابدأ بـ Basic',
    },
    {
      id:    'pro',
      ...
      period: '/شهر',
      color: '#9b59b6',
      features: _planFeatures(9),    // أول 9 مميزات (+ تقارير, مخزون, موردين, موظفين, عملاء)
      cta:   'ترقية لـ Pro',
    },
    {
      id:    'mega',
      ...
      color: '#e74c3c',
      badge: 'الأكثر مبيعاً',
      features: _planFeatures(12),   // كل المميزات مفتوحة
      cta:   'احصل على Mega 🚀',
    },
  ];
